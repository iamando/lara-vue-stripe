      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51IpdGcKsExWSA0lqbrsoJ3Cb2nFbnjQROrUawMQTe6k3g7osbr85ruaeAJ7kioNPhodbzRd9hbMk2dQpcAKXhWJL00AKcp2OAL");
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                if (error) {
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_2___default().post("/api/purchase", _this2.customer).then(function (response) {
                    _this2.paymentProcessing = false;
    ...
    return _c("thead", [
      _c("tr", [
        _c(
          ...
          {
            staticClass:
              "px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 rounded rounded-bl"
          },
          [_vm._v("\n            Item\n          ")]
        ),
        _vm._v(" "),
